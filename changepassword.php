    ...
    border-bottom-right-radius: 5px 5px; border-right: thin solid #fff ">
        ...
        <div id=main>
            ...
            <div id="mainpage">
                ...
                <p>From this page you can change your current password, just enter your current username and password, then enter the new password you would like to start using.</p>
                <form method = "post">
